...
function TvAndFilms() {
  const tvandfilms = [
    ...
    { name: 'HEADIE ONE - CRY', image: '/tvandfilms/pink.png', detail: '/', className: 'breakSpatialText'},
    { name: 'TENA - DISCREET', image: '/tvandfilms/Benefit.png', detail: '/', className: '' },
    ...
    { name: 'SONIA STEIN - ZOOM OUT', image: '/tvandfilms/Destree.jpg', detail: '/', className: 'breakSpatialText'},
    { name: 'TIDE - FOUNDERS MAKE SOME NOISE!', image: '/tvandfilms/pink.png', detail: '/', className: 'breakSpatialText'},
    ...
    { name: 'SLOW BURN', image: '/tvandfilms/Destree.jpg', detail: '/', className: ''},
    { name: 'TESCO - FOOD LOVE STORIES', image: '/tvandfilms/pink.png', detail: '/', className: 'breakSpatialText'},
    { name: 'NETFLIX - CHOOSE OR DIE', image: '/tvandfilms/Benefit.png', detail: '/', className: 'breakSpatialText' },
    { name: 'RBS - CHARIOTS OF DREAMS', image: '/tvandfilms/Gisou.jpg', detail: '/', className: 'breakSpatialText'},
    ...
    { name: 'CAPO LEE - STYLE & SWAG', image: '/tvandfilms/Benefit.png', detail: '/', className: '' },
    { name: 'ROCKS FOE - NITTY GRITTY', image: '/tvandfilms/Gisou.jpg', detail: '/', className: ''},
